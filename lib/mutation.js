  ...
  addPeople : async (root, { courseID, personID }) => {
    ...
    try {
      ...
      await db.collection('courses').updateOne(
        ...
        {
          // addtoset buscar si hay un arreglo en ese campo
          // addToSet va a buscar people es un array y si no lo va
          // a convertir en un array y le va a buscar por personId
